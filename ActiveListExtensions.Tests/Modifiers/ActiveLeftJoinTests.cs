...
namespace ActiveListExtensions.Tests.Modifiers
{
	...
	{
		[Fact]
		public void RandomlyChangeParameter() => CollectionTestHelpers.RandomlyChangeParameterInTwoCollections((l1, l2, p) => l1.ActiveLeftJoin(l2, p, (l, i) => l.Property + i.Property, (r, i) => r.Property + i.Property, (l, r, i) => l.Property + (r != null ? r.Property : 0) + i.Property), (l1, l2, p) => l1.LeftJoin(l2, i => i.Property + p.Property, i => i.Property + p.Property, (i1, i2) => i1.Property + (i2?.Property ?? 0) + p.Property), () => new IntegerTestClass() { Property = RandomGenerator.GenerateRandomInteger(0, 100) }, () => new IntegerTestClass() { Property = RandomGenerator.GenerateRandomInteger(0, 100) });
