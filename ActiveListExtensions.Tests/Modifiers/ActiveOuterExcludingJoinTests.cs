...
namespace ActiveListExtensions.Tests.Modifiers
{
	public class ActiveOuterExcludingJoinTests
	{
		...
		[Fact]
		public void RandomlyChangeKeyValues() => CollectionTestHelpers.RandomlyChangePropertyValuesInTwoCollections((l1, l2) => l1.ActiveOuterExcludingJoin(l2, l => l.Key, r => r.Key, (l, r) => l.Match(v => v.Property, 0) + r.GetOrElse(new IntegerTestClass()).Property), (l1, l2) => l1.OuterExcludingJoin(l2, l => l.Key, r => r.Key, (l, r) => l.Match(v => v.Property, 0) + r.GetOrElse(new IntegerTestClass()).Property), () => RandomGenerator.GenerateRandomTestClass(), () => RandomGenerator.GenerateRandomTestClass(), o => o.Key = RandomGenerator.GenerateRandomInteger(), o => o.Key = RandomGenerator.GenerateRandomInteger());

		[Fact]
		public void RandomlyChangePropertyValues() => CollectionTestHelpers.RandomlyChangePropertyValuesInTwoCollections((l1, l2) => l1.ActiveOuterExcludingJoin(l2, l => l.Key, r => r.Key, (l, r) => l.Match(v => v.Property, 0) + r.GetOrElse(new IntegerTestClass()).Property), (l1, l2) => l1.OuterExcludingJoin(l2, l => l.Key, r => r.Key, (l, r) => l.Match(v => v.Property, 0) + r.GetOrElse(new IntegerTestClass()).Property), () => RandomGenerator.GenerateRandomTestClass(), () => RandomGenerator.GenerateRandomTestClass(), o => o.Property = RandomGenerator.GenerateRandomInteger(), o => o.Property = RandomGenerator.GenerateRandomInteger());
	}
}
