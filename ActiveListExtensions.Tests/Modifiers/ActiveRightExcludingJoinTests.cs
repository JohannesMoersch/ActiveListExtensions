...
namespace ActiveListExtensions.Tests.Modifiers
{
	...
	{
		[Fact]
		public void RandomlyChangeParameter() => CollectionTestHelpers.RandomlyChangeParameterInTwoCollections((l1, l2, p) => l1.ActiveRightExcludingJoin(l2, p, (l, i) => (l != null ? l.Property : 0) + i.Property, (r, i) => r.Property + i.Property, (l, r, i) => (l != null ? l.Property : 0) + r.Property + i.Property), (l1, l2, p) => l1.RightExcludingJoin(l2, i => i.Property + p.Property, i => i.Property + p.Property, (i1, i2) => (i1?.Property ?? 0) + i2.Property + p.Property), () => new IntegerTestClass() { Property = RandomGenerator.GenerateRandomInteger(0, 100) }, () => new IntegerTestClass() { Property = RandomGenerator.GenerateRandomInteger(0, 100) });
