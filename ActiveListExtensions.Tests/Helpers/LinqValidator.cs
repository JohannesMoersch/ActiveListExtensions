...
namespace ActiveListExtensions.Tests.Helpers
{
	...
	{
		private Func<IReadOnlyList<T1>> _originalCollection1;

		private Func<IReadOnlyList<T2>> _originalCollection2;
		...
		public LinqValidator(IReadOnlyList<T1> originalCollection, IReadOnlyList<U> processedCollection, Func<IReadOnlyList<T1>, IEnumerable<U>> linqEquivalent, bool useSetComparison, Func<U, object> keySelector, Func<U, U, bool> additionalComparer = null)
			: this(() => originalCollection, processedCollection, linqEquivalent, useSetComparison, keySelector, additionalComparer)
		{
		}

		public LinqValidator(Func<IReadOnlyList<T1>> originalCollection, IReadOnlyList<U> processedCollection, Func<IReadOnlyList<T1>, IEnumerable<U>> linqEquivalent, bool useSetComparison, Func<U, object> keySelector, Func<U, U, bool> additionalComparer = null)
		...
		public LinqValidator(IReadOnlyList<T1> originalCollection1, IReadOnlyList<T2> originalCollection2, IReadOnlyList<U> processedCollection, Func<IReadOnlyList<T1>, IReadOnlyList<T2>, IEnumerable<U>> linqEquivalent, bool useSetComparison, Func<U, object> keySelector, Func<U, U, bool> additionalComparer = null)
			: this(() => originalCollection1, () => originalCollection2, processedCollection, linqEquivalent, useSetComparison, keySelector, additionalComparer)
		{
		}

		public LinqValidator(Func<IReadOnlyList<T1>> originalCollection1, Func<IReadOnlyList<T2>> originalCollection2, IReadOnlyList<U> processedCollection, Func<IReadOnlyList<T1>, IReadOnlyList<T2>, IEnumerable<U>> linqEquivalent, bool useSetComparison, Func<U, object> keySelector, Func<U, U, bool> additionalComparer = null)
		{
		...
		{
			var fromLinq = _linqEquivalent.Invoke(_originalCollection1.Invoke(), _originalCollection2?.Invoke()).ToArray();
