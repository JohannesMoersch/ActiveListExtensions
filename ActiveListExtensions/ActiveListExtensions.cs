...
namespace ActiveListExtensions
{
	...
	public static class ActiveListExtensions
	{
		...
		private static IActiveList<TResult> ActiveInnerJoin<TLeft, TRight, TResult, TKey>(this IActiveList<TLeft> source, IEnumerable<TRight> join, Func<TLeft, TKey> leftKeySelector, Func<TRight, TKey> rightKeySelector, Func<TLeft, TRight, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, object>(ActiveListJoinBehaviour.Inner, source, join.ToReadOnlyList(), leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4);
		...
		private static IActiveList<TResult> ActiveLeftJoin<TLeft, TRight, TResult, TKey>(this IActiveList<TLeft> source, IEnumerable<TRight> join, Func<TLeft, TKey> leftKeySelector, Func<TRight, TKey> rightKeySelector, Func<TLeft, TRight, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, object>(ActiveListJoinBehaviour.Left, source, join.ToReadOnlyList(), leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4);
		...
		private static IActiveList<TResult> ActiveLeftExcludingJoin<TLeft, TRight, TResult, TKey>(this IActiveList<TLeft> source, IEnumerable<TRight> join, Func<TLeft, TKey> leftKeySelector, Func<TRight, TKey> rightKeySelector, Func<TLeft, TRight, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, object>(ActiveListJoinBehaviour.LeftExcluding, source, join.ToReadOnlyList(), leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4);
		...
		private static IActiveList<TResult> ActiveRightJoin<TLeft, TRight, TResult, TKey>(this IActiveList<TLeft> source, IEnumerable<TRight> join, Func<TLeft, TKey> leftKeySelector, Func<TRight, TKey> rightKeySelector, Func<TLeft, TRight, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, object>(ActiveListJoinBehaviour.Right, source, join.ToReadOnlyList(), leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4);
		...
		private static IActiveList<TResult> ActiveRightExcludingJoin<TLeft, TRight, TResult, TKey>(this IActiveList<TLeft> source, IEnumerable<TRight> join, Func<TLeft, TKey> leftKeySelector, Func<TRight, TKey> rightKeySelector, Func<TLeft, TRight, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, object>(ActiveListJoinBehaviour.RightExcluding, source, join.ToReadOnlyList(), leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4);
