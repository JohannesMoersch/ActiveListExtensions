...
namespace ActiveListExtensions
{
	...
	public static class ActiveListExtensions
	{
		...
		public static IActiveList<TResult> ActiveSelect<TSource, TResult>(this IActiveList<TSource> source, Func<TSource, IMutableActiveValue<TResult>> selector, IEnumerable<string> propertiesToWatch) => new ActiveSelectValue<TSource, object, TResult>(source, selector, propertiesToWatch);
		...
		public static IActiveSetList<TSource> ActiveDistinct<TSource>(this IActiveList<TSource> source) => new ActiveDistinct<TSource, TSource, object>(source, o => o, null);

		public static IActiveSetList<TSource> ActiveDistinct<TSource, TKey>(this IActiveList<TSource> source, Expression<Func<TSource, TKey>> keySelector) => ActiveDistinct(source, keySelector.Compile(), keySelector.GetReferencedProperties());

		public static IActiveSetList<TSource> ActiveDistinct<TSource, TKey>(this IActiveList<TSource> source, Func<TSource, TKey> keySelector, IEnumerable<string> propertiesToWatch) => new ActiveDistinct<TKey, TSource, object>(source, keySelector, propertiesToWatch);

		public static IActiveSetList<TSource> ActiveDistinct<TSource, TKey, TParameter>(this IActiveList<TSource> source, IActiveValue<TParameter> parameter, Expression<Func<TSource, TParameter, TKey>> keySelector) => ActiveDistinct(source, parameter, keySelector.Compile(), keySelector.GetReferencedProperties());

		public static IActiveSetList<TSource> ActiveDistinct<TSource, TKey, TParameter>(this IActiveList<TSource> source, IActiveValue<TParameter> parameter, Func<TSource, TParameter, TKey> keySelector, IEnumerable<string> sourcePropertiesToWatch, IEnumerable<string> parameterPropertiesToWatch) => ActiveDistinct(source, parameter, keySelector, Tuple.Create(sourcePropertiesToWatch, parameterPropertiesToWatch));

		private static IActiveSetList<TSource> ActiveDistinct<TSource, TKey, TParameter>(this IActiveList<TSource> source, IActiveValue<TParameter> parameter, Func<TSource, TParameter, TKey> keySelector, Tuple<IEnumerable<string>, IEnumerable<string>> propertiesToWatch) => new ActiveDistinct<TKey, TSource, TParameter>(source, keySelector, parameter, propertiesToWatch.Item1, propertiesToWatch.Item2);


		public static IActiveSetList<TSource> ActiveUnion<TSource>(this IActiveList<TSource> source, IEnumerable<TSource> union) => new ActiveUnion<TSource, TSource, object>(source, union.ToReadOnlyList(), o => o, null);

		public static IActiveSetList<TSource> ActiveUnion<TSource, TKey>(this IActiveList<TSource> source, IEnumerable<TSource> union, Expression<Func<TSource, TKey>> keySelector) => ActiveUnion(source, union, keySelector.Compile(), keySelector.GetReferencedProperties());

		public static IActiveSetList<TSource> ActiveUnion<TSource, TKey>(this IActiveList<TSource> source, IEnumerable<TSource> union, Func<TSource, TKey> keySelector, IEnumerable<string> propertiesToWatch) => new ActiveUnion<TKey, TSource, object>(source, union.ToReadOnlyList(), keySelector, propertiesToWatch);

		public static IActiveSetList<TSource> ActiveUnion<TSource, TKey, TParameter>(this IActiveList<TSource> source, IEnumerable<TSource> union, IActiveValue<TParameter> parameter, Expression<Func<TSource, TParameter, TKey>> keySelector) => ActiveUnion(source, union, parameter, keySelector.Compile(), keySelector.GetReferencedProperties());
		...
		private static IActiveSetList<TSource> ActiveUnion<TSource, TKey, TParameter>(this IActiveList<TSource> source, IEnumerable<TSource> union, IActiveValue<TParameter> parameter, Func<TSource, TParameter, TKey> keySelector, Tuple<IEnumerable<string>, IEnumerable<string>> propertiesToWatch) => new ActiveUnion<TKey, TSource, TParameter>(source, union.ToReadOnlyList(), keySelector, parameter, propertiesToWatch.Item1, propertiesToWatch.Item2);


		public static IActiveSetList<TSource> ActiveIntersect<TSource>(this IActiveList<TSource> source, IEnumerable<TSource> intersect) => new ActiveIntersect<TSource, TSource, object>(source, intersect.ToReadOnlyList(), o => o, null);

		public static IActiveSetList<TSource> ActiveIntersect<TSource, TKey>(this IActiveList<TSource> source, IEnumerable<TSource> intersect, Expression<Func<TSource, TKey>> keySelector) => ActiveIntersect(source, intersect, keySelector.Compile(), keySelector.GetReferencedProperties());

		public static IActiveSetList<TSource> ActiveIntersect<TSource, TKey>(this IActiveList<TSource> source, IEnumerable<TSource> intersect, Func<TSource, TKey> keySelector, IEnumerable<string> propertiesToWatch) => new ActiveIntersect<TKey, TSource, object>(source, intersect.ToReadOnlyList(), keySelector, propertiesToWatch);
		...
		private static IActiveSetList<TSource> ActiveIntersect<TSource, TKey, TParameter>(this IActiveList<TSource> source, IEnumerable<TSource> intersect, IActiveValue<TParameter> parameter, Func<TSource, TParameter, TKey> keySelector, Tuple<IEnumerable<string>, IEnumerable<string>> propertiesToWatch) => new ActiveIntersect<TKey, TSource, TParameter>(source, intersect.ToReadOnlyList(), keySelector, parameter, propertiesToWatch.Item1, propertiesToWatch.Item2);


		public static IActiveSetList<TSource> ActiveExcept<TSource>(this IActiveList<TSource> source, IEnumerable<TSource> except) => new ActiveExcept<TSource, TSource, object>(source, except.ToReadOnlyList(), o => o, null);

		public static IActiveSetList<TSource> ActiveExcept<TSource, TKey>(this IActiveList<TSource> source, IEnumerable<TSource> except, Expression<Func<TSource, TKey>> keySelector) => ActiveExcept(source, except, keySelector.Compile(), keySelector.GetReferencedProperties());

		public static IActiveSetList<TSource> ActiveExcept<TSource, TKey>(this IActiveList<TSource> source, IEnumerable<TSource> except, Func<TSource, TKey> keySelector, IEnumerable<string> propertiesToWatch) => new ActiveExcept<TKey, TSource, object>(source, except.ToReadOnlyList(), keySelector, propertiesToWatch);

		public static IActiveSetList<TSource> ActiveExcept<TSource, TKey, TParameter>(this IActiveList<TSource> source, IEnumerable<TSource> except, IActiveValue<TParameter> parameter, Expression<Func<TSource, TParameter, TKey>> keySelector) => ActiveExcept(source, except, parameter, keySelector.Compile(), keySelector.GetReferencedProperties());
