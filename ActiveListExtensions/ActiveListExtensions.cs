...
namespace ActiveListExtensions
{
	...
	public static class ActiveListExtensions
	{
		...
		private static IActiveList<TResult> ActiveInnerJoin<TLeft, TRight, TResult, TKey>(this IActiveList<TLeft> source, IEnumerable<TRight> join, Func<TLeft, TKey> leftKeySelector, Func<TRight, TKey> rightKeySelector, Func<TLeft, TRight, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, object>(ActiveJoinBehaviour.Inner, source, join.ToReadOnlyList(), leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4);
		...
		public static IActiveList<TResult> ActiveInnerJoin<TLeft, TRight, TResult, TKey, TParameter>(this IActiveList<TLeft> source, IEnumerable<TRight> join, IActiveValue<TParameter> parameter, Func<TLeft, TParameter, TKey> leftKeySelector, Func<TRight, TParameter, TKey> rightKeySelector, Func<TLeft, TRight, TParameter, TResult> resultSelector, IEnumerable<string> leftKeySelectorPropertiesToWatch, IEnumerable<string> rightKeySelectorPropertiesToWatch, IEnumerable<string> leftResultSelectorPropertiesToWatch, IEnumerable<string> rightResultSelectorPropertiesToWatch, IEnumerable<string> parameterPropertiesToWatch)
			=> ActiveInnerJoin(source, join, parameter, leftKeySelector, rightKeySelector, resultSelector, Tuple.Create(leftKeySelectorPropertiesToWatch, rightKeySelectorPropertiesToWatch, leftResultSelectorPropertiesToWatch, rightResultSelectorPropertiesToWatch, parameterPropertiesToWatch));

		private static IActiveList<TResult> ActiveInnerJoin<TLeft, TRight, TResult, TKey, TParameter>(this IActiveList<TLeft> source, IEnumerable<TRight> join, IActiveValue<TParameter> parameter, Func<TLeft, TParameter, TKey> leftKeySelector, Func<TRight, TParameter, TKey> rightKeySelector, Func<TLeft, TRight, TParameter, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, TParameter>(ActiveJoinBehaviour.Inner, source, join.ToReadOnlyList(), parameter, leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4, propertiesToWatch.Item5);


		public static IActiveList<TResult> ActiveLeftJoin<TLeft, TRight, TResult, TKey>(this IActiveList<TLeft> source, IEnumerable<TRight> join, Expression<Func<TLeft, TKey>> leftKeySelector, Expression<Func<TRight, TKey>> rightKeySelector, Expression<Func<TLeft, TRight, TResult>> resultSelector)
		...
		private static IActiveList<TResult> ActiveLeftJoin<TLeft, TRight, TResult, TKey>(this IActiveList<TLeft> source, IEnumerable<TRight> join, Func<TLeft, TKey> leftKeySelector, Func<TRight, TKey> rightKeySelector, Func<TLeft, TRight, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, object>(ActiveJoinBehaviour.Left, source, join.ToReadOnlyList(), leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4);
		...
		public static IActiveList<TResult> ActiveLeftJoin<TLeft, TRight, TResult, TKey, TParameter>(this IActiveList<TLeft> source, IEnumerable<TRight> join, IActiveValue<TParameter> parameter, Func<TLeft, TParameter, TKey> leftKeySelector, Func<TRight, TParameter, TKey> rightKeySelector, Func<TLeft, TRight, TParameter, TResult> resultSelector, IEnumerable<string> leftKeySelectorPropertiesToWatch, IEnumerable<string> rightKeySelectorPropertiesToWatch, IEnumerable<string> leftResultSelectorPropertiesToWatch, IEnumerable<string> rightResultSelectorPropertiesToWatch, IEnumerable<string> parameterPropertiesToWatch)
			=> ActiveLeftJoin(source, join, parameter, leftKeySelector, rightKeySelector, resultSelector, Tuple.Create(leftKeySelectorPropertiesToWatch, rightKeySelectorPropertiesToWatch, leftResultSelectorPropertiesToWatch, rightResultSelectorPropertiesToWatch, parameterPropertiesToWatch));

		private static IActiveList<TResult> ActiveLeftJoin<TLeft, TRight, TResult, TKey, TParameter>(this IActiveList<TLeft> source, IEnumerable<TRight> join, IActiveValue<TParameter> parameter, Func<TLeft, TParameter, TKey> leftKeySelector, Func<TRight, TParameter, TKey> rightKeySelector, Func<TLeft, TRight, TParameter, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, TParameter>(ActiveJoinBehaviour.Left, source, join.ToReadOnlyList(), parameter, leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4, propertiesToWatch.Item5);


		public static IActiveList<TResult> ActiveLeftExcludingJoin<TLeft, TRight, TResult, TKey>(this IActiveList<TLeft> source, IEnumerable<TRight> join, Expression<Func<TLeft, TKey>> leftKeySelector, Expression<Func<TRight, TKey>> rightKeySelector, Expression<Func<TLeft, TRight, TResult>> resultSelector)
		...
		private static IActiveList<TResult> ActiveLeftExcludingJoin<TLeft, TRight, TResult, TKey>(this IActiveList<TLeft> source, IEnumerable<TRight> join, Func<TLeft, TKey> leftKeySelector, Func<TRight, TKey> rightKeySelector, Func<TLeft, TRight, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, object>(ActiveJoinBehaviour.LeftExcluding, source, join.ToReadOnlyList(), leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4);
		...
		public static IActiveList<TResult> ActiveLeftExcludingJoin<TLeft, TRight, TResult, TKey, TParameter>(this IActiveList<TLeft> source, IEnumerable<TRight> join, IActiveValue<TParameter> parameter, Func<TLeft, TParameter, TKey> leftKeySelector, Func<TRight, TParameter, TKey> rightKeySelector, Func<TLeft, TRight, TParameter, TResult> resultSelector, IEnumerable<string> leftKeySelectorPropertiesToWatch, IEnumerable<string> rightKeySelectorPropertiesToWatch, IEnumerable<string> leftResultSelectorPropertiesToWatch, IEnumerable<string> rightResultSelectorPropertiesToWatch, IEnumerable<string> parameterPropertiesToWatch)
			=> ActiveLeftExcludingJoin(source, join, parameter, leftKeySelector, rightKeySelector, resultSelector, Tuple.Create(leftKeySelectorPropertiesToWatch, rightKeySelectorPropertiesToWatch, leftResultSelectorPropertiesToWatch, rightResultSelectorPropertiesToWatch, parameterPropertiesToWatch));

		private static IActiveList<TResult> ActiveLeftExcludingJoin<TLeft, TRight, TResult, TKey, TParameter>(this IActiveList<TLeft> source, IEnumerable<TRight> join, IActiveValue<TParameter> parameter, Func<TLeft, TParameter, TKey> leftKeySelector, Func<TRight, TParameter, TKey> rightKeySelector, Func<TLeft, TRight, TParameter, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, TParameter>(ActiveJoinBehaviour.LeftExcluding, source, join.ToReadOnlyList(), parameter, leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4, propertiesToWatch.Item5);


		public static IActiveList<TResult> ActiveRightJoin<TLeft, TRight, TResult, TKey>(this IActiveList<TLeft> source, IEnumerable<TRight> join, Expression<Func<TLeft, TKey>> leftKeySelector, Expression<Func<TRight, TKey>> rightKeySelector, Expression<Func<TLeft, TRight, TResult>> resultSelector)
		...
		private static IActiveList<TResult> ActiveRightJoin<TLeft, TRight, TResult, TKey>(this IActiveList<TLeft> source, IEnumerable<TRight> join, Func<TLeft, TKey> leftKeySelector, Func<TRight, TKey> rightKeySelector, Func<TLeft, TRight, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, object>(ActiveJoinBehaviour.Right, source, join.ToReadOnlyList(), leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4);
		...
		public static IActiveList<TResult> ActiveRightJoin<TLeft, TRight, TResult, TKey, TParameter>(this IActiveList<TLeft> source, IEnumerable<TRight> join, IActiveValue<TParameter> parameter, Func<TLeft, TParameter, TKey> leftKeySelector, Func<TRight, TParameter, TKey> rightKeySelector, Func<TLeft, TRight, TParameter, TResult> resultSelector, IEnumerable<string> leftKeySelectorPropertiesToWatch, IEnumerable<string> rightKeySelectorPropertiesToWatch, IEnumerable<string> leftResultSelectorPropertiesToWatch, IEnumerable<string> rightResultSelectorPropertiesToWatch, IEnumerable<string> parameterPropertiesToWatch)
			=> ActiveRightJoin(source, join, parameter, leftKeySelector, rightKeySelector, resultSelector, Tuple.Create(leftKeySelectorPropertiesToWatch, rightKeySelectorPropertiesToWatch, leftResultSelectorPropertiesToWatch, rightResultSelectorPropertiesToWatch, parameterPropertiesToWatch));

		private static IActiveList<TResult> ActiveRightJoin<TLeft, TRight, TResult, TKey, TParameter>(this IActiveList<TLeft> source, IEnumerable<TRight> join, IActiveValue<TParameter> parameter, Func<TLeft, TParameter, TKey> leftKeySelector, Func<TRight, TParameter, TKey> rightKeySelector, Func<TLeft, TRight, TParameter, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, TParameter>(ActiveJoinBehaviour.Right, source, join.ToReadOnlyList(), parameter, leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4, propertiesToWatch.Item5);


		public static IActiveList<TResult> ActiveRightExcludingJoin<TLeft, TRight, TResult, TKey>(this IActiveList<TLeft> source, IEnumerable<TRight> join, Expression<Func<TLeft, TKey>> leftKeySelector, Expression<Func<TRight, TKey>> rightKeySelector, Expression<Func<TLeft, TRight, TResult>> resultSelector)
		...
		private static IActiveList<TResult> ActiveRightExcludingJoin<TLeft, TRight, TResult, TKey>(this IActiveList<TLeft> source, IEnumerable<TRight> join, Func<TLeft, TKey> leftKeySelector, Func<TRight, TKey> rightKeySelector, Func<TLeft, TRight, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, object>(ActiveJoinBehaviour.RightExcluding, source, join.ToReadOnlyList(), leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4);
		...
		public static IActiveList<TResult> ActiveRightExcludingJoin<TLeft, TRight, TResult, TKey, TParameter>(this IActiveList<TLeft> source, IEnumerable<TRight> join, IActiveValue<TParameter> parameter, Func<TLeft, TParameter, TKey> leftKeySelector, Func<TRight, TParameter, TKey> rightKeySelector, Func<TLeft, TRight, TParameter, TResult> resultSelector, IEnumerable<string> leftKeySelectorPropertiesToWatch, IEnumerable<string> rightKeySelectorPropertiesToWatch, IEnumerable<string> leftResultSelectorPropertiesToWatch, IEnumerable<string> rightResultSelectorPropertiesToWatch, IEnumerable<string> parameterPropertiesToWatch)
			=> ActiveRightExcludingJoin(source, join, parameter, leftKeySelector, rightKeySelector, resultSelector, Tuple.Create(leftKeySelectorPropertiesToWatch, rightKeySelectorPropertiesToWatch, leftResultSelectorPropertiesToWatch, rightResultSelectorPropertiesToWatch, parameterPropertiesToWatch));

		private static IActiveList<TResult> ActiveRightExcludingJoin<TLeft, TRight, TResult, TKey, TParameter>(this IActiveList<TLeft> source, IEnumerable<TRight> join, IActiveValue<TParameter> parameter, Func<TLeft, TParameter, TKey> leftKeySelector, Func<TRight, TParameter, TKey> rightKeySelector, Func<TLeft, TRight, TParameter, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, TParameter>(ActiveJoinBehaviour.RightExcluding, source, join.ToReadOnlyList(), parameter, leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4, propertiesToWatch.Item5);


		public static IActiveList<TResult> ActiveOuterJoin<TLeft, TRight, TResult, TKey>(this IActiveList<TLeft> source, IEnumerable<TRight> join, Expression<Func<TLeft, TKey>> leftKeySelector, Expression<Func<TRight, TKey>> rightKeySelector, Expression<Func<TLeft, TRight, TResult>> resultSelector)
		...
		private static IActiveList<TResult> ActiveOuterJoin<TLeft, TRight, TResult, TKey>(this IActiveList<TLeft> source, IEnumerable<TRight> join, Func<TLeft, TKey> leftKeySelector, Func<TRight, TKey> rightKeySelector, Func<TLeft, TRight, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, object>(ActiveJoinBehaviour.Outer, source, join.ToReadOnlyList(), leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4);
		...
		public static IActiveList<TResult> ActiveOuterJoin<TLeft, TRight, TResult, TKey, TParameter>(this IActiveList<TLeft> source, IEnumerable<TRight> join, IActiveValue<TParameter> parameter, Func<TLeft, TParameter, TKey> leftKeySelector, Func<TRight, TParameter, TKey> rightKeySelector, Func<TLeft, TRight, TParameter, TResult> resultSelector, IEnumerable<string> leftKeySelectorPropertiesToWatch, IEnumerable<string> rightKeySelectorPropertiesToWatch, IEnumerable<string> leftResultSelectorPropertiesToWatch, IEnumerable<string> rightResultSelectorPropertiesToWatch, IEnumerable<string> parameterPropertiesToWatch)
			=> ActiveOuterJoin(source, join, parameter, leftKeySelector, rightKeySelector, resultSelector, Tuple.Create(leftKeySelectorPropertiesToWatch, rightKeySelectorPropertiesToWatch, leftResultSelectorPropertiesToWatch, rightResultSelectorPropertiesToWatch, parameterPropertiesToWatch));

		private static IActiveList<TResult> ActiveOuterJoin<TLeft, TRight, TResult, TKey, TParameter>(this IActiveList<TLeft> source, IEnumerable<TRight> join, IActiveValue<TParameter> parameter, Func<TLeft, TParameter, TKey> leftKeySelector, Func<TRight, TParameter, TKey> rightKeySelector, Func<TLeft, TRight, TParameter, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, TParameter>(ActiveJoinBehaviour.Outer, source, join.ToReadOnlyList(), parameter, leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4, propertiesToWatch.Item5);


		public static IActiveList<TResult> ActiveOuterExcludingJoin<TLeft, TRight, TResult, TKey>(this IActiveList<TLeft> source, IEnumerable<TRight> join, Expression<Func<TLeft, TKey>> leftKeySelector, Expression<Func<TRight, TKey>> rightKeySelector, Expression<Func<TLeft, TRight, TResult>> resultSelector)
		...
		private static IActiveList<TResult> ActiveOuterExcludingJoin<TLeft, TRight, TResult, TKey>(this IActiveList<TLeft> source, IEnumerable<TRight> join, Func<TLeft, TKey> leftKeySelector, Func<TRight, TKey> rightKeySelector, Func<TLeft, TRight, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, object>(ActiveJoinBehaviour.OuterExcluding, source, join.ToReadOnlyList(), leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4);
		...
		public static IActiveList<TResult> ActiveOuterExcludingJoin<TLeft, TRight, TResult, TKey, TParameter>(this IActiveList<TLeft> source, IEnumerable<TRight> join, IActiveValue<TParameter> parameter, Func<TLeft, TParameter, TKey> leftKeySelector, Func<TRight, TParameter, TKey> rightKeySelector, Func<TLeft, TRight, TParameter, TResult> resultSelector, IEnumerable<string> leftKeySelectorPropertiesToWatch, IEnumerable<string> rightKeySelectorPropertiesToWatch, IEnumerable<string> leftResultSelectorPropertiesToWatch, IEnumerable<string> rightResultSelectorPropertiesToWatch, IEnumerable<string> parameterPropertiesToWatch)
			=> ActiveOuterExcludingJoin(source, join, parameter, leftKeySelector, rightKeySelector, resultSelector, Tuple.Create(leftKeySelectorPropertiesToWatch, rightKeySelectorPropertiesToWatch, leftResultSelectorPropertiesToWatch, rightResultSelectorPropertiesToWatch, parameterPropertiesToWatch));

		private static IActiveList<TResult> ActiveOuterExcludingJoin<TLeft, TRight, TResult, TKey, TParameter>(this IActiveList<TLeft> source, IEnumerable<TRight> join, IActiveValue<TParameter> parameter, Func<TLeft, TParameter, TKey> leftKeySelector, Func<TRight, TParameter, TKey> rightKeySelector, Func<TLeft, TRight, TParameter, TResult> resultSelector, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> propertiesToWatch)
			=> new ActiveJoin<TLeft, TRight, TResult, TKey, TParameter>(ActiveJoinBehaviour.OuterExcluding, source, join.ToReadOnlyList(), parameter, leftKeySelector, rightKeySelector, resultSelector, propertiesToWatch.Item1, propertiesToWatch.Item2, propertiesToWatch.Item3, propertiesToWatch.Item4, propertiesToWatch.Item5);
		...
		private static Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> CreateJoinPropertiesToWatchTuple(Tuple<IEnumerable<string>, IEnumerable<string>> leftKeySelectorPropertiesToWatch, Tuple<IEnumerable<string>, IEnumerable<string>> rightKeySelectorPropertiesToWatch, Tuple<IEnumerable<string>, IEnumerable<string>, IEnumerable<string>> resultSelectorPropertiesToWatch)
			=> Tuple.Create(leftKeySelectorPropertiesToWatch.Item1, rightKeySelectorPropertiesToWatch.Item1, resultSelectorPropertiesToWatch.Item1, resultSelectorPropertiesToWatch.Item2, leftKeySelectorPropertiesToWatch.Item2.Concat(rightKeySelectorPropertiesToWatch.Item2).Concat(resultSelectorPropertiesToWatch.Item3).Distinct().ToArray().AsEnumerable());
	}
}