...
namespace ActiveListExtensions.Modifiers
{
	...
	{
		public ActiveIntersect(IActiveList<TSource> leftSource, IActiveList<TSource> rightSource, Func<TSource, TKey> keySelector, IEnumerable<string> propertiesToWatch)
			: this(leftSource, rightSource, keySelector, null, propertiesToWatch, null)
		{
		}

		public ActiveIntersect(IActiveList<TSource> leftSource, IActiveList<TSource> rightSource, Func<TSource, TParameter, TKey> keySelector, IActiveValue<TParameter> parameter, IEnumerable<string> sourcePropertiesToWatch, IEnumerable<string> parameterPropertiesToWatch) 
		...
		private ActiveIntersect(IActiveList<TSource> leftSource, IActiveList<TSource> rightSource, Func<TSource, TKey> keySelector, IActiveValue<TParameter> parameter, IEnumerable<string> sourcePropertiesToWatch, IEnumerable<string> parameterPropertiesToWatch)
