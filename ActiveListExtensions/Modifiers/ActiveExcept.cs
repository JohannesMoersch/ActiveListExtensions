...
{
	internal class ActiveExcept<T, U> : ActiveSetBase<T, U>
	{
		public ActiveExcept(IActiveList<T> leftSource, IActiveList<T> rightSource, Func<T, U> keySelector, IEnumerable<string> propertiesToWatch = null) 
